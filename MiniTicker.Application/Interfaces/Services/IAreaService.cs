...
namespace MiniTicker.Core.Application.Interfaces.Services
{
    public interface IAreaService
    {
        ...
        Task<AreaDto> CreateAsync(CreateAreaDto dto, CancellationToken cancellationToken); Task<AreaDto> UpdateAsync(Guid id, AreaDto dto, CancellationToken cancellationToken = default);
